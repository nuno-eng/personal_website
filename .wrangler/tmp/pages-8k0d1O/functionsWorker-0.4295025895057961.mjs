...
var COPY = {
  en: {
    ...
    body: /* @__PURE__ */ __name((link, n) => [`Here is your personal referral link:`, link, `People who have subscribed through it so far: ${n}.`], "body")
  },
  pt: {
    ...
    body: /* @__PURE__ */ __name((link, n) => ["Aqui est\xE1 o seu link pessoal de recomenda\xE7\xE3o:", link, `Pessoas que j\xE1 subscreveram atrav\xE9s dele: ${n}.`], "body")
  }
};
...
var COPY2 = {
  en: {
    greeting: /* @__PURE__ */ __name((name) => name ? `Hi ${name},` : "Hi,", "greeting"),
    signoff: "Nuno",
  ...
  pt: {
    greeting: /* @__PURE__ */ __name((name) => name ? `Ol\xE1 ${name},` : "Ol\xE1,", "greeting"),
    signoff: "Nuno",
...
async function sendWelcomeSequence({ env, base, email, code, name, lang, referralLink: referralLink2 }) {
  ...
  const send = /* @__PURE__ */ __name((kind, scheduledAt) => {
...
// ../.wrangler/tmp/pages-8k0d1O/functionsRoutes-0.9538524021379248.mjs
var routes = [
  {
...
// ../../../../../private/tmp/claude-501/-Users-nunofontoura-Documents-VesselOperatingSystem/6efa97fe-c3af-49f8-8ab3-5071268061cd/scratchpad/wr/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../private/tmp/claude-501/-Users-nunofontoura-Documents-VesselOperatingSystem/6efa97fe-c3af-49f8-8ab3-5071268061cd/scratchpad/wr/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-eYyReI/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-eYyReI/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4295025895057961.mjs.map
