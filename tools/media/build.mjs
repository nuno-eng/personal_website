...
const SHARE = [
  ...
  { out: 'business-advisory', lang: 'en', kicker: 'Biz Ops Advisory', title: 'Stop being <b>founder-led.</b>' },
...
<style>
  *{box-sizing:border-box;margin:0}
  ...
  .photo img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:24% 30%;opacity:.5;filter:saturate(.8)}
  .photo::before{content:"";position:absolute;inset:0;z-index:1;background:linear-gradient(90deg,#0F1D3D 0%,rgba(15,29,61,.68) 30%,rgba(15,29,61,.42) 100%)}
</style></head><body>
