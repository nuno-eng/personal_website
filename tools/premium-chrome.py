...
NAV = {
 'en': dict(home='/', skip='Skip to content', open='Open menu', close='Close menu', lang_label='Language: English', book='Book a call', book_href='/book/',
            links=[('About', '/about/'), ('Operations Advisory', '/business-advisory/'), ('Free Resources', '/free-resources/')],
            mobile_home='Home'),
 'pt': dict(home='/pt/', skip='Saltar para o conte&uacute;do', open='Abrir menu', close='Fechar menu', lang_label='Idioma: Portugu&ecirc;s', book='Marcar chamada', book_href='/pt/book/',
            links=[('Assessoria de Opera&ccedil;&otilde;es', '/pt/business-advisory/')],
...
FOOT = {
 'en': dict(contact='Contact', support='Support', follow='Follow', pages='Pages', privacy=('Privacy', '/privacy/'), other='Portugu&ecirc;s',
            links=[('Operations Advisory', '/business-advisory/'), ('About', '/about/'), ('Vessel Operating System', '/vessel-operating-system/'), ('Case studies', '/case-studies/'), ('Free Resources', '/free-resources/'), ('Free VOS assessment', 'https://vos.nabiaedge.com/trial'), ('Newsletter', '/subscribe/'), ('Book a call', '/book/')]),
 'pt': dict(contact='Contacto', support='Suporte', follow='Redes', pages='P&aacute;ginas', privacy=('Privacidade', '/pt/privacy/'), other='English',
            links=[('In&iacute;cio', '/pt/'), ('Assessoria de Opera&ccedil;&otilde;es', '/pt/business-advisory/'), ('Avalia&ccedil;&atilde;o VOS gratuita', 'https://vos.nabiaedge.com/trial'), ('Newsletter', '/pt/subscribe/'), ('Marcar chamada', '/pt/book/')]),
}
...
def footer(lang, alt):
    ...
    links = '\n'.join(f'      <a href="{h}"{ext(h)}>{t}</a>' for t, h in f['links'])
